...
## BLITZ DE TRAJETO NO APLICATIVO CHECKLIST
...
Para realizar blitz de trajeto em colaboradores AMBEV, deve selecionar empresa ambev e a filial da transportadora em que atuam. Se os colaboradores não aparecerem, verifique na tela RH COLABORADORES se estão cadastrados e se o modal foi informado.
1- Selecione o colabordor
para realizar a blitz
2- Verifique se a placa está
