...
- Selecione DTO  
- Clique em Realizar DTO  
- Selecione o DTO desejado  
- Informe Filial, Grupo DTO e Tipo de DTO  
- Selecione o colaborador e clique no “+” para adicionar (até 3 colaboradores por DTO)  
- Clique em Iniciar  
- Marque as opções como OK ou NOK  
- Em caso de NOK, informe o colaborador responsável  
